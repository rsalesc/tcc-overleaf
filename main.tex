...
\catalogtopics{1. Software forensics. 2. Authorship identification. 3. Deep learning} % Listar palavras-chave do trabalho para a FICHA CATALOGRAFICA}, por exemplo, ``1. Complexidade Estrutural. 2. Qualidade de Software 3. Engenharia de Software''
...
\begin{keywords}
perícia de software, identificação de autoria, aprendizagem profunda
\end{keywords}
...
\begin{keywords}
software forensics, authorship identification, deep learning
\end{keywords}
