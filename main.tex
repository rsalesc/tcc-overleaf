...
\title{An efficient algorithm for isometrically embedding weighted trees into low-dimensional $\ell_\infty$-normed spaces}
...
\author{Jonathan Coutinho Luz de Queiroz}
...
\authorcitationname{Queiroz, Jonathan} % e.g. Terceiro, Antonio Soares de Azevedo
\advisercitationname{Januario, Tiago} % e.g. Chavez, Christina von Flach Garcia
...
\approvalsheet{Salvador, ?? de dezembro de 2018}{
   \comittemember{Prof. Dr. Tiago Januario}{Universidade Federal da Bahia}
...
\begin{keywords}
exact algorithm, isometric embedding, maximum norm
\end{keywords}
